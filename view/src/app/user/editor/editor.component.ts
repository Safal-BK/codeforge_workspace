...
export class EditorComponent implements OnInit, OnDestroy {
  ...
  constructor(private codexservice: CodexserviceService, private clipboard: Clipboard, private route:Router) {
  ...
  ngOnInit(): void {
    ...
    this.checkisexpired()
    setTimeout(() =>     this.deletetoken()
    , 1000);
    this.updatetimer = setInterval(()=>this.savesession(),1500)
  ...
  checkisexpired(){
    ...
    this.codexservice.reqistokenexpired(body).subscribe((res: any) => {
...
deletetoken(){
  ...
  this.codexservice.reqdeletetoken(body).subscribe((res: any) => {
    console.log(res);
  })
}
  getsession() {
    ...
    this.codexservice.reqsession(body).subscribe((res: any) => {
      console.log(res);
  ...
  savesession() {
    ...
    this.codexservice.reqsavesession(body).subscribe((res) => {
      // console.log(res);
...
console.log('changed......');
  ...
  compilecode() {
    ...
    this.codexservice.reqcompilecode(body).subscribe((res:any) => {
      console.log(res);
